      ...
      <div class="bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl border border-slate-200/60 dark:border-slate-800 p-8 rounded-[2rem] shadow-sm relative overflow-hidden group">
        <div class="relative z-10">
          <div class="flex flex-col items-center mb-10">
            ...
            <h1 class="text-2xl font-extrabold text-slate-900 dark:text-white mb-2 tracking-tight">Recuperar Acceso</h1>
          ...
          <form v-else @submit.prevent="handleSubmit" class="space-y-6">
            ...
            <router-link to="/" class="block text-center text-slate-500 font-bold uppercase tracking-widest text-[10px] hover:text-slate-900 dark:text-white transition-colors"> Cancelar </router-link>
          </form>
        </div>
      </div>
    </div>
